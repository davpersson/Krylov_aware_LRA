...
semilogy(2*k*s_list,krylov_aware_truncated,'b-+','LineWidth',3,'MarkerSize', 12)
semilogy(2*k*s_list,svk_krylov_aware_untruncated,'m-|','LineWidth',3,'MarkerSize', 12)
semilogy(2*k*s_list,svk_krylov_aware_truncated,'m--^','LineWidth',3,'MarkerSize', 12)
legend({'Optimal','Krylov aware (untruncated)','Krylov aware (truncated)',...
    'Single vector Krylov aware (untruncated)','Single vector Krylov aware (truncated)'},'location','best')
